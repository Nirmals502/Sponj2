...
public class adapter_for_people extends BaseAdapter {
    int int_counter = 0;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (getItemViewType(position) == 0) { // Item
            ...
            Typeface type2 = Typeface.createFromAsset(parent.getContext().getAssets(), "Roboto-Regular.ttf");
...
//                        int_counter = 3;
                            ...
                            if (int_counter == 3) {
                                ...
                                i.putExtra("Check_screen", "people");
