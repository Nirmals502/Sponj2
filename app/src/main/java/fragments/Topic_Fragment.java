 ...
 * {@link Topic_Fragment.OnFragmentInteractionListener} interface
...
public class Topic_Fragment extends Fragment {
    ...
    private Topic_Fragment.OnFragmentInteractionListener mListener;
    DatabaseHandler db;
    ListView lv;
...
//                }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof People_Fragmant.OnFragmentInteractionListener) {
            mListener = (Topic_Fragment.OnFragmentInteractionListener) context;
        } else {
